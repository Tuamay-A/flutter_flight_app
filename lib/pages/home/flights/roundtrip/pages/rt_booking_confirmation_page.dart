...
class RtBookingConfirmationPage extends StatelessWidget {
  ...
  const RtBookingConfirmationPage({super.key, required this.booking});
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            'Your round-trip itinerary is ready. A confirmation email has been sent.',
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (seat != null) ...[
            const SizedBox(height: 10),
            _detailRow(context, Icons.event_seat, 'Seat $seat'),
          ],
